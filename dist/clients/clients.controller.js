...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Lister tous les clients' }),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Rechercher des clients' }),
    (0, swagger_1.ApiQuery)({ name: 'q', description: 'Recherche par numéro abonné, nom ou téléphone' }),
